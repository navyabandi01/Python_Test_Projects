...
# This part is image labels setting start 
        ...
        std_b1_1 = Button(bg_img,text="M.Shreya",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        det_b1_1 = Button(bg_img,text="L.Sharana",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        att_b1_1 = Button(bg_img,text="B.Navya",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
