...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CSE","CME","IT","ECE","AI&DS")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","BE","MBA")
        cou_combo.current(0)
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Mentor:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
